    ...
    def generate_instances(self, experiment):
        ...
        for trial in experiment.trials:
            ...
            for sys in experiment.systems:
                data_path = instance_path(experiment.output_path, self, sys, sys.timeout, trial)
                ...
                if isinstance(sys, NoisyPopper) or isinstance(sys, MaxSynth):
                    train_settings = self.generate_popper(data_path, pos_train_examples, neg_train_examples)
                elif isinstance(sys, Aleph):
                    train_settings = self.generate_aleph(sys, data_path, pos_train_examples, neg_train_examples)
