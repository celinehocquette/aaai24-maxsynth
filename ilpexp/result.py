...
class ExperimentResult:
    def __init__(self, problem_name, system_id, system_name, trial, solution, total_exec_time, conf_matrix, extra_stats,
                 timeout, parameter=None, combine_time=None, best_mdl=None):
    ...
    def __str__(self):
        return f'{self.problem_name}__{self.system_name}__{self.system_id} :: {self.total_exec_time:.2f}s / {self.timeout} :: {self.accuracy}'
