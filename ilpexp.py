...
PARSER.add_argument('--threads', type=int, default=4, help='Number of concurrent threads to run. Defaults to half the number of cpus if not specified.')
...
if __name__ == '__main__':
    ...
    runner = SimpleRunner(num_threads=4)
