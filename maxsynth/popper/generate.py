...
class Generator:
    ...
    def build_generalisation_constraint(self, prog, rule_ordering=None, gen_size=False):
        new_handles = set()
        prog = list(prog)
        rule_index = {}
        literals = []
    ...
    def banish_constraint(self, prog, rule_ordering={}):
        new_handles = set()
        prog = list(prog)
        rule_index = {}
        literals = []
    ...
    def build_specialisation_constraint(self, prog, rule_ordering=None, spec_size=None):
        new_handles = set()
        prog = list(prog)
        rule_index = {}
        literals = []
    ...
    def tmp_con(self, prog, rule_ordering={}):
        for rule in prog:
